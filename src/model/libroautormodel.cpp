#include "libroautormodel.h"

LibroAutorModel::LibroAutorModel(QObject *parent,
						   ConsConfEnum conf) :
LibroAutorModelBase(parent)
{
	Q_UNUSED(conf)	//delete
	//setConsConf( conf ); //uncomment
}

LibroAutorModel::~LibroAutorModel()
{
}
...
*/
void LibroAutorModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant LibroAutorModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	LibroAutorRecord *r=(LibroAutorRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant LibroAutorModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return LibroAutorModelBase::headerData(section,
									orientation,
									role); //delete

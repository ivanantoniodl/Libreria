...
UsuarioCargoModel::UsuarioCargoModel(QObject *parent,
						   ConsConfEnum conf) :
UsuarioCargoModelBase(parent)
{
	Q_UNUSED(conf)	//delete
	//setConsConf( conf ); //uncomment
}

UsuarioCargoModel::~UsuarioCargoModel()
{
}
...
*/
void UsuarioCargoModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant UsuarioCargoModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	UsuarioCargoRecord *r=(UsuarioCargoRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant UsuarioCargoModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return UsuarioCargoModelBase::headerData(section,
									orientation,
									role); //delete

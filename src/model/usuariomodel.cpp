...
*/
void UsuarioModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant UsuarioModel::getRecordValue(RecordBase *record,int column) const
{
...
*/
QVariant UsuarioModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return UsuarioModelBase::headerData(section,
									orientation,
									role); //delete

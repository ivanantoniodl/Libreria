...
LugarModel::LugarModel(QObject *parent,
						   ConsConfEnum conf) :
LugarModelBase(parent)
{
...
*/
void LugarModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant LugarModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	LugarRecord *r=(LugarRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant LugarModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return LugarModelBase::headerData(section,
									orientation,
									role); //delete

...
LibroModel::LibroModel(QObject *parent,
						   ConsConfEnum conf) :
LibroModelBase(parent)
{
...
*/
void LibroModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant LibroModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	LibroRecord *r=(LibroRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant LibroModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return LibroModelBase::headerData(section,
									orientation,
									role); //delete

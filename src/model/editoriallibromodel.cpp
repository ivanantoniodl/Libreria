#include "editoriallibromodel.h"

EditorialLibroModel::EditorialLibroModel(QObject *parent,
						   ConsConfEnum conf) :
EditorialLibroModelBase(parent)
{
	Q_UNUSED(conf)	//delete
	//setConsConf( conf ); //uncomment
}

EditorialLibroModel::~EditorialLibroModel()
{
}
...
*/
void EditorialLibroModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant EditorialLibroModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	EditorialLibroRecord *r=(EditorialLibroRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant EditorialLibroModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return EditorialLibroModelBase::headerData(section,
									orientation,
									role); //delete

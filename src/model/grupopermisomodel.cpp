...
GrupoPermisoModel::GrupoPermisoModel(QObject *parent,
						   ConsConfEnum conf) :
GrupoPermisoModelBase(parent)
{
	Q_UNUSED(conf)	//delete
	//setConsConf( conf ); //uncomment
}

GrupoPermisoModel::~GrupoPermisoModel()
{
}
...
*/
void GrupoPermisoModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant GrupoPermisoModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	GrupoPermisoRecord *r=(GrupoPermisoRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant GrupoPermisoModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return GrupoPermisoModelBase::headerData(section,
									orientation,
									role); //delete

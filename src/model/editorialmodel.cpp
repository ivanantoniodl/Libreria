#include "editorialmodel.h"

EditorialModel::EditorialModel(QObject *parent,
						   ConsConfEnum conf) :
EditorialModelBase(parent)
{
...
*/
void EditorialModel::configureInternalSelectQuery()
{
	switch (getConsConf())
	{
	case Default:
...
*/
QVariant EditorialModel::getRecordValue(RecordBase *record,int column) const
{
	return ModelBase::getRecordValue(record,column); //delete

//	EditorialRecord *r=(EditorialRecord*)record;
//	switch (getConsConf())
//	{
//	case Default:
//		return ModelBase::getRecordValue(record,column);
...
*/
QVariant EditorialModel::headerData(int section,
								  Qt::Orientation orientation,
								  int role) const
{
	return EditorialModelBase::headerData(section,
									orientation,
									role); //delete

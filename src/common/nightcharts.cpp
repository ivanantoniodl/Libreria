...
int Nightcharts::draw(QPainter *painter)
{
    ...
    else if (this->ctype==Nightcharts::Histogramm)
    {
        ...
        for (int i=0;i<pieces.size();i++)
        {
            ...
            QString label = QString::number(pieces[i].pPerc,'f',2)+"%";
...
int Nightcharts::drawLegend(QPainter *painter)
{
    ...
    case Nightcharts::Round:
        for (int i=pieces.size()-1;i>=0;i--)
        {
            ...
            QString label = pieces[i].pname + " - " + QString::number(pieces[i].pPerc,'f',2)+"%";
...
Qt::GlobalColor Nightcharts::nextColor()
{
    colorindex++;
    switch ( colorindex )
    {
    ...
    case 8: return Qt::white;
    case 9: return Qt::darkBlue;
    case 10: return Qt::darkCyan;
    case 11: return Qt::darkGray;
    case 12: return Qt::darkGreen;
    case 13: return Qt::darkMagenta;
    case 14: return Qt::darkRed;
    case 15: return Qt::darkYellow;

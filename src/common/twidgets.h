...
class COMMONSHARED_EXPORT TPixmap : public QGraphicsObject
{
	Q_OBJECT
public:
...
class COMMONSHARED_EXPORT TMenuWidget : public QFrame
{
Q_OBJECT
private:
	QVBoxLayout *lyt;
...
class COMMONSHARED_EXPORT TMenuButton : public QPushButton
{
Q_OBJECT
private:
	QString Menu;
